  ...
  return (
    <footer className={styles.wrap}>
      <p className={styles.copyright}>
        <small>©︎ 2019 Coco Kiryu - <button type="button" className={styles.btn} onClick={onclick}　aria-expanded={isExpanded}>Material</button> - <a href="https://github.com/Kiryu-kai/semi-permanent-contract">Repository</a> - <a href="/">Home</a></small>
      </p>
